...
Los resultados obtenidos de esta prueba se exponen en la tabla \ref{tab:lecturaEncoders} muestran similitudes con los de la tabla \ref{tab:desplazamientoRobot} de la prueba anterior. Sin embargo, esta última prueba añade un componente de información extra que permite
