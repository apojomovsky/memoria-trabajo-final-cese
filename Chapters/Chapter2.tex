...
\begin{itemize}
    ...
    \item \textbf{Manifiesto del paquete}: está representado por un archivo único dentro del paquete y el mismo contiene información sobre el mismo tal como el nombre, autor, tipo de licencia, dependencias, banderas de compilación, etc. El archivo \file{package.xml} encontrado en la raíz del paquete es su propio manifiesto.
...
\footnotetext{\url{Imagen tomada de https://uncrate.com/assets_c/2009/04/roomba-560-stretched-thumb-960x640-3177.jpg}}
...
\footnotetext{\url{Imagen tomada de https://cdn-shop.adafruit.com/datasheets/create_2_Open_Interface_Spec.pdf}}
...
\footnotetext{\url{Imagen tomada de https://www.carminenoviello.com/wp-content/uploads/2015/12/nucleo_144_large-2-660x330.jpg}}
...
\footnotetext{\url{Imagen tomada de http://skiras.blogspot.com/2012/10/4copter-conceptos-i-ejes-giros-y-fuerzas.html}}
