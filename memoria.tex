...
\thesistitle{Firmware para robot autónomo utilizando FreeRTOS} % El títulos de la memoria, se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \ttitle
...
\author{Alexis Martin Pojomovsky} % Tu nombre, se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \authorname
...
\begin{abstract}
	...
	En el presente trabajo se describe el desarrollo de un robot móvil de bajo costo, destinado a ser utilizado por estudiantes universitarios en el aprendizaje de tópicos de robótica, tales como odometría, localización y navegación.

	Esta propuesta se ajusta a dos importantes restricciones: disponibilidad de componentes en el mercado local y bajo precio, siendo esta última relativa a productos comerciales de similares características.
