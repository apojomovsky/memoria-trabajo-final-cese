...
La presente memoria describe el desarrollo del robot móvil ``Lubobot``, destinado a utilizarse en entornos educativos de grado universitario a través de las distintas etapas de estudio de la materia ``Robótica Móvil``. Como parte del trabajo se realizó la implementación básica requerida para utilizar este robot en el Sistema Operativo Robótico (ROS) tales como odometría, localización y navegación del mismo en entornos de dos dimensiones.\newline
Se aplicaron diversos conocimientos adquiridos durante la carrera, entre los que destacan los sistemas operativos, control de versiones y protocolos de comunicación, así como patrones de diseño y modularización de software.
...
Agradezco el apoyo proveído por mi esposa Laura así como el de mis padres Evelyn y Ernesto, presentes durante todo el proceso de mi formación, siempre alentándome a ir un paso mas allá.\newline
Al equipo docente y colaboradores de la Carrera de Especialización de Sistemas Embebidos, por la dedicación y entrega manifestados en cada paso de la cursada.
