...
\thesistitle{Firmware basado en ROS para la navegación autónoma de un robot diferencial utilizando fusión de sensores} % El títulos de la memoria, se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \ttitle
...
Se aplicaron diversos conocimientos adquiridos durante la carrera, entre los que se destacan los referidos a sistemas operativos, desarrollo de controladores e interfaces para perifericos, control de versiones y protocolos de comunicación. Así también, se hizo uso de patrones de diseño y técnicas de modularización de software.
...
Agradezco el apoyo provisto por mi esposa Laura así como el de mis padres Evelyn y Ernesto, presentes durante todo el proceso de mi formación, siempre alentándome a ir un paso más allá.\\
